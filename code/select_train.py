...
# 假设txt文件路径和语音集目录如下  
txt_file_path = 'F:\\thesis\data_set\LA\ASVspoof2019_LA_eval\\flac\ASVspoof2019.LA.cm.eval.trl.txt'  
voice_set_directory = 'F:\\thesis\data_set\LA\ASVspoof2019_LA_eval\\flac'  
  
# 创建文件夹列表  
folder_names = ['bonafide', 'fake']  
       ...
       # 查找类型部分是否以'--'或'-'开头，并去除开头的'--'或'-'  
        ...
        if os.path.exists(source_path):  
            ...
            if file_type == 'bonafide': 
              ...
              destination_path = os.path.join(voice_set_directory, 'fake', file_name+ '.flac' )
